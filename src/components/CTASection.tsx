...
export const CTASection: React.FC = () => {
  ...
  return (
    <section id="contact" ref={containerRef} className="py-20 px-6 bg-zinc-50">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          >
            <div>
              <h3 className="text-2xl font-semibold text-zinc-800 mb-6">
                Get in touch
              </h3>
            ...
            <div className="space-y-6">
              {contactInfo.map((item, index) => (
                ...
                >
                  <motion.div className="w-12 h-12 bg-gradient-to-br from-zinc-800 to-zinc-900 text-white rounded-2xl flex items-center justify-center mr-4 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-200">
                    {item.icon}
                  </motion.div>
                  <div>
